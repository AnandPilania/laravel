...
var timeout;
var connUrl = 'http://128.199.146.220:3000';
...
rTypeArr.push('Curious Onlooker');
  ...
  if(friends.friendlist.length>0){
    friends.friendlist.forEach(function(friend) {
      ...
      if(!friend.avatar || friend.avatar=='' ){
        html += '<img src="'+Url+'/img/dummy-head.png"/>';
        ...
        html += '<img src="'+Url+'/img/memberImages/'+friend.avatar+'"/>';
      }
...
function mobilefriendListtoHTml(friends,callback){
  ...
  if(friends.friendlist.length>0){
    friends.friendlist.forEach(function(friend) {
      ...
      html += '<img src="'+Url+'/img/msg-ic.png" class="msg-ic">';
      html += '</div></span></a></div>';
    });
  }else{
      ...
      if(messages.length>0){
          messages.forEach(function(msg){
            ...
            if(!msg.avatar || msg.avatar==''){
              ...
              html += '<img src="'+Url+'/img/memberImages/'+msg.avatar+'"/>';
            }
...
function mobilepopmodel(id, name, data,requestId){
  ...
  html += '<button onclick="sendMessage(this,'+id+');"><img src="'+Url+'/img/send.png"></button>';
...
function register_popup(id, name, data,requestId){
    ...
    // element = element + '<p><img src="http://www.flyingchalks.com/dev/img/dummy.jpg"><span class="msg-box"></span></p>';
    // element = element +  '<p><img src="http://www.flyingchalks.com/dev/img/dummy.jpg"><span class="time-msgbox">Monday at 7:45 PM<span class="msg-box"></span></span></p>';
    // element = element +  '<p><img src="http://www.flyingchalks.com/dev/img/dummy.jpg"><span class="msg-box"></span></p>';
    // element = element +  '<p><img src="http://www.flyingchalks.com/dev/img/dummy.jpg"><span class="time-msgbox">Monday at 7:45 PM<span class="msg-box"></span></span></p>';
    // element = element + '</div>';
    element = element + '</div>';
    ...
    //element = element + '<input type="text" class="msgInput" onkeypress="onkeypressinput(event,'+id+')" id="msg-'+id+'" ><button onclick="sendMessage(this,'+id+');" ><img src="http://www.flyingchalks.com/dev/img/send.png"></button>';
    element = element + '<textarea  class="msgInput" onkeypress="onkeypressinput(event,'+id+')" id="msg-'+id+'" ></textarea><button onclick="sendMessage(this,'+id+');" ><img src="'+Url+'/img/send.png"></button>';
    element = element + '</div>';
    element = element + '</div>';
