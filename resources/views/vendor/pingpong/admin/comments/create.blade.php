  ...
  <div class="panel-body">
    <div class="row">
      <div class="col-sm-10">
        ...
        <form id="aboutus" class="form-horizontal" role="form" autocomplete="off" novalidate action="{{ URL::route('admin.comments.store') }}" method="POST" enctype="multipart/form-data">
