...
@endif
	...
	<div class="form-group">
		@if($model->image)
		<img class="img-responsive" src="{!! asset('/images/universities/' . $model->image) !!}">
		@endif
	</div>
	@endif
	<div class="form-group">
	...
	<div class="form-group">
		...
		<img class="img-responsive" src="{!! asset('/images/banner/' . $model->banner_image) !!}">
		@endif
	</div>
	@endif
	<div class="form-group">
...
@section('script')
	...
	<script type="text/javascript">
		...
		CKFinder.setupCKEditor( editor10, prefix + '/vendor/ckfinder/') ;
