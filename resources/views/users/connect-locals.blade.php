@foreach ($localExchanges as $index => $exchangeDetail)
    <div class="col-md-6">
            ...
            <div class="peers-area">
                ...
                <div>
                    ...
                    <div class="user-info-area">
                        <ul>
                            @if ($exchangeDetail['type'] == 1 || $exchangeDetail['type'] == 2 )
                                @if ($exchangeDetail['type'] == 1)
                        ...
                        @if (Auth::guest())
                            <p class="pro-button"><a href="javascript:void(0);" onclick="showError('{!! trans('community.please_login') !!}', 5000);$('html, body').animate({scrollTop : 0}, 800);">{!! trans('community.start_chat') !!}</a></p>
                        @elseif ($userData->exchange == NULL)
                            <p class="pro-button"><a href="javascript:void(0);" onclick="showError('{!! trans('community.please_update') !!}', 10000);$('html, body').animate({scrollTop : 0}, 800);">Start a chat!</a></p>
